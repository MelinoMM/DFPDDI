...
def settings():
    ...
    parser.add_argument('--lr', type=float, default=1e-3,
                        help='Initial learning rate. Default is 5e-4.origin:1e-3')
    ...
    parser.add_argument('--loss_ratio2', type=float, default=0.3,
                        help='Ratio of task2. Default is 0.1')

    parser.add_argument('--loss_ratio3', type=float, default=0.3,
                        help='Ratio of task3. Default is 0.1')

    parser.add_argument('--loss_ratio4', type=float, default=0.5,
                        help='Ratio of task3. Default is 0.1')
    
    parser.add_argument('--loss_dpl', type=float, default=0.00005,
                        help='Ratio of loss_dpl. Default is 0.0001')
    ...
    parser.add_argument('--sigma', type=float, default=1.6,
                        help='Bandwidth.  Default is 1.6')
    parser.add_argument('--beta', type=float, default=2,
                        help='Ratio of beta loss. Default is 0.1')
    parser.add_argument('--loss_ratio5', type=float, default=0.3,
                        help='Ratio of loss. Default is 0.1')
    
    # t-SNE
    parser.add_argument('--tsne', default=100, help='Number of tsne.')
